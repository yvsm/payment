...
$payData = [
    ...
    'store_id'   => '',
    'quit_url'   => 'https://zunyunkeji.com', // 收银台的返回按钮（用户打断支付操作时返回的地址,4.0.3版本新增）
];

// 使用
try {
    $client = new \zunyunkeji\payment\Client(\zunyunkeji\payment\Client::ALIPAY, $aliConfig);
    $res    = $client->pay(\zunyunkeji\payment\Client::ALI_CHANNEL_WAP, $payData);
